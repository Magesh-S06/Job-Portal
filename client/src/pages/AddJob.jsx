    ...
    <form className='container p-4 flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select className='w-full px-3 py-2 border-2 border-gray-300 rounded outline-blue-500' onChange={e=>setCategory(e.target.value)}>
        ...
        <div>
          ...
          <select className='w-full px-3 py-2 border-2 border-gray-300 rounded outline-blue-500' onChange={e=>setLocation(e.target.value)}>
        ...
        <div>
          ...
          <select className='w-full px-3 py-2 border-2 border-gray-300 rounded outline-blue-500' onChange={e=>setLevel(e.target.value)}>
